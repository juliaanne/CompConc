...
int funcao,nthreads, nparticoes, nParticoesParaCalcular = 2, nParticoesPorThread, threadsExecutaram = 0, nparticoesIteracao = 1, out;
...
double calcula_integral(double localA, double localB){
    ...
    double altura = 2;
    switch(funcao){
        case 1:altura = calcula_funcao1((base/2) + localA);break;
        case 2:altura = calcula_funcao2((base/2) + localA);break;
        case 3:altura = calcula_funcao3((base/2) + localA);break;
        case 4:altura = calcula_funcao4((base/2) + localA);break;
        case 5:altura = calcula_funcao5((base/2) + localA);break;
    }
